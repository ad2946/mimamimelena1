				...
				<div class="container inner">
					...
					<div class="row">
						<div class="col-md-8 col-sm-9 center-block text-center">
							<header>
								<h1>Informaci&oacuten de Contacto</h1>
								<p>&iquestQuieres modificar alg&uacuten dato? Puedes hacerlo a continuaci&oacuten...</p>
							</header>
						</div><!-- /.col -->
					</div><!-- /.row -->
						...
						<div class="col-sm-12">
							<div class="row">
								...
								<div class="col-sm-6 outer-top-md inner-left-sm border-left">
									<h2>Informaci&oacuten de la cuenta</h2>
									<form id="modificarInfo" class="forms" action="update.php" method="post">
										...
										<div class="row">
											<div class="col-sm-6">
												<p>Apellidos: <br>
												<input type="text" name="apellidos" class="form-control" value=<?php echo $apellidos ?> required></p>
											</div><!-- /.col -->
										</div><!-- /.row -->
										...
										<div class="row">
											<div class="col-sm-6">
												<p>Email: <br>
												<input type="email" name="email" class="form-control" value=<?php echo $email ?> required></p>
											</div><!-- /.col -->
										</div><!-- /.row -->
								...
								<div class="col-sm-6 outer-top-md inner-left-sm border-left">
										<div class="row">
											<div class="col-sm-6">
												<p>Usuario: <br>
												<input type="text" name="user" class="form-control" value=<?php echo $usuario ?> required></p>
											</div><!-- /.col -->
										</div><!-- /.row -->
										...
										<div class="row">
											<div class="col-sm-6">
												<p>Tel&eacutefono: <br>
												<input type="text" name="numero" class="form-control" value=<?php echo $numero ?> required></p>
											</div><!-- /.col -->
										</div><!-- /.row -->
										
										<button type="submit" name="registro" class="btn btn-default btn-submit">Modificar Datos</button>
