...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-06-2018 a las 13:54:42
...
(1, 1, 1, 'Cepillo Redondo de Cerdas de Jabalí 25 mm', 55.5, 'images/hair-boarbrush-25.jpg', '', ''),
(2, 1, 1, 'Cepillo Redondo de Cerdas de Jabalí 35 mm', 64.5, 'images/hair-boarbrush-35.jpg', '', ''),
(3, 1, 1, 'Cepillo Redondo de Cerdas de Jabalí 45 mm', 70, 'images/hair-boarbrush-45.jpg', '', ''),
(4, 1, 1, 'Moroccanoil Cepillo Plano de Cerámica', 27, 'images/hair_ceramicbrush_paddle.jpg', '', ''),
(5, 1, 1, 'Moroccanoil Cepillo Redondo de Cerámica 35 mm', 27, 'images/hair_ceramicbrush_35.jpg', '', ''),
(6, 1, 1, 'Moroccanoil Cepillo Redondo de Cerámica 55 mm', 32.5, 'images/hair_ceramicbrush_55.jpg', '', ''),
(7, 1, 1, 'Moroccanoil Cepillo Térmico Cerámica Iónica Redondo 25mm.', 19.5, 'images/hair_ceramicbrush_25.jpg', '', ''),
(8, 1, 1, 'Cepillo clásico de cerdas de jabalí', 55.5, 'images/hair_boarbrush_paddle.jpg', '', ''),
(9, 1, 4, 'MOROCCANOIL PACK HIDRATACIÓN', 81.5, 'images/moroccanoil_hydrating_champ_-_acond_-_tratanmieto_hydrating.jpg', 'Para cabellos que necesitan un extra de hidratación…', 'hidratacion'),
(10, 1, 4, 'MOROCCANOIL PACK REPAIR', 75, 'images/pack-morocanoil-reparador3.jpg', 'Esta caja de regalo no necesita envoltorio. ¡Es el regalo perfecto!', 'reparacion'),
(11, 1, 4, 'MOROCCANOIL PACK VOLUMEN', 93.5, 'images/pack-morocanoil-volumen3.jpg', 'Esta caja de regalo no necesita envoltorio. ¡Es el regalo perfecto!', 'volumen'),
(12, 1, 3, 'MOROCCANOIL SMOOTH CONDITIONER REDUCTOR VOLUMEN', 28.5, 'images/hair_smoothing_conditioner.jpg', 'PARA TODO TIPO DE CABELLO : Esta fórmula acondiciona, desenreda, suaviza y controla el cabello rebelde y encrespado. El Acondicionador Suavizante Moroccanoil®, incluye nuestro ingrediente exclusivo AminoRenew™, que restaura los aminoácidos vencidos para fortalecer y alinear la estructura de la queratina natural del cabello.', 'volumen'),
(13, 1, 2, 'MOROCCANOIL SMOOTH SHAMPOO REDUCTOR VOLUMEN.', 26.5, 'images/hair_smoothing_shampoo.jpg', 'PARA TODO TIPO DE CABELLO: Suavice y controle el cabello rebelde y encrespado con esta suave fórmula limpiadora. El Champú Suavizante Moroccanoil®, con nuestro exclusivo ingrediente AminoRenew™, restaura los aminoácidos vencidos para fortalecer y alinear la estructura de la queratina natural del cabello.', 'volumen'),
(14, 1, 2, 'CHAMPÚ SECO TONOS CLAROS', 27, 'images/dryshampoolight.png', 'Para Todo Tipo de Cabello:  Moroccanoil Dry Shampoo está enriquecido con Aceite de Argán ,El Champú Seco Tonos Claros Moroccanoil® contiene almidones ultra finos de arroz que absorben la grasa y los olores dejando el cabello renovado, fresco y con volumen. La fórmula, impregnada con aceite de argán, provee protección UV y contiene matices violetas para equilibrar los tonos cobrizos en cabellos rubios, y resaltar lo mejor en cabellos con tonos claros.', 'claro'),
(15, 1, 2, 'CHAMPÚ SECO TONOS OSCUROS', 27, 'images/dryshampoodark.png', 'Para Todo Tipo de Cabello : Moroccanoil Dry Shampoo está enriquecido con Aceite de Argán ,El Champú Seco Oscuros Moroccanoil® contiene almidones ultra finos de arroz que absorben la grasa y los olores dejando el cabello limpio y fresco. La fórmula, impregnada con aceite de argán, provee protección UV y actúa de inmediato sin dejar residuos opacos mientras mantiene la riqueza natural de los tonos de cabellos oscuros y morenos.', 'oscuro'),
(16, 1, 2, 'Moroccanoil Clarifying Shampoo', 24.5, 'images/hair_clarifying_shampoo.jpg', 'PARA CABELLO SOBRECARGADO POR LA ACUMULACIÓN DE PRODUCTOS :  Champú Purificante nutre su cabello mientras limpia y elimina suavemente las impurezas. No altera el color. Sin sulfatos, fosfatos ni parabenos. Puede ser usado antes de un tratamiento de color, permanente, o tratamientos químicos y obtener mejores resultados.', ''),
(17, 1, 3, 'Moroccanoil Extra Volume Conditioner', 26.5, 'images/hair_extravolume_conditioner.jpg', 'PARA CABELLO FINO : Desenreda suavemente su cabello mientras añade volumen. El Acondicionador Extra Volumen Moroccanoil® provee volumen, cuerpo, brillo, y manejabilidad al cabello fino sin hacerlo más pesado o comprimido.', 'volumen'),
(18, 1, 2, 'Moroccanoil Extra Volume Shampoo', 24.5, 'images/extra_volume.jpg', 'PARA CABELLO FINO  : ¡Añada volumen y llene de vida el cabello fino y apagado! El Champú Extra Volumen Moroccanoil® actúa sin añadir peso, limpia suavemente, y añade volumen al cabello fino y sin vida. Impregnado con aceite de argán rico en antioxidantes y nutrientes revitalizantes', 'volumen'),
(19, 1, 3, 'Moroccanoil Hydrating Conditioner', 24.5, 'images/Hydrating_Conditioner.png', 'PARA TODO TIPO DE CABELLO : Acondicione y desenrede el cabello deshidratado con el Acondicionador Hidratante Moroccanoil® . Esta fórmula suave de uso diario deja el cabello más suave, manejable, y facilita la creación de estilos y peinados.', 'hidratacion'),
(20, 1, 2, 'Moroccanoil Hydrating Shampoo', 22, 'images/hair_hydrating_shampoo.jpg', 'PARA TODO TIPO DE CABELLO : Aporte al cabello seco y deshidratado toda la hidración que tanto necesita. El Champú Hidratante Moroccanoil® acondiciona el cabello con aceite de argán rico en antioxidantes, vitamina A, vitamina E, y algas rojas para lograr un cabello que se ve y se siente más saludable.', 'hidratacion'),
(21, 1, 3, 'Moroccanoil Moisture Repair Conditioner', 22.05, 'images/acond._reparador.jpg', 'PARA EL CABELLO DEBILITADO O DAÑADO : Recupere el cabello dañado a causa de los tintes, procesos químicos, o el uso del calor para peinados y estilismos. El Acondicionador Reparador Hidratante Moroccanoil® acondiciona y desenreda suave y efectivamente el cabello dejándolo hidratado, fuerte y manejable.', 'reparacion'),
(22, 1, 2, 'Moroccanoil Moisture Repair Shampoo', 22.5, 'images/champu_reparador.jpg', 'PARA EL CABELLO DEBILITADO O DAÑADO : Repare el cabello dañado a causa de los tintes, procesos químicos, o el uso del calor para peinados y estilismos. El Champú Reparador Hidratante Moroccanoil® limpia suave y efectivamente el cabello dejándolo con vida, nutrido, fuerte y manejable.', 'reparacion'),
(23, 1, 5, 'Moroccanoil Dry Scalp Treatment', 37, 'images/dry_scalp.png', 'PARA CUERO CABELLUDO SECO :  Nuestro tratamiento profesional para el cuero cabelludo cubre las necesidades del cuero cabelludo seco y escamoso, aliviando inmediatamente la irritación, resequedad, y picazón.', 'seco'),
(24, 1, 5, 'Moroccanoil Oily Scalp Treatment', 37, 'images/oily_scalp.png', 'PARA CUERO CABELLUDO GRASO : Un cuero cabelludo graso puede dejar el cabello sin vida. El Tratamiento Cuero Cabelludo Graso Moroccanoil® es un tratamiento profesional para el cuero cabelludo diseñado para controlar la producción excesiva de aceite y revivir el cabello.', 'graso'),
(25, 1, 6, 'MOROCCANOIL SMOOTH CONCENTRADO PARA EL SECADO', 28.5, 'images/smooth_secado.png', 'PARA CUERO CABELLUDO GRASO : Un cuero cabelludo graso puede dejar el cabello sin vida. El Tratamiento Cuero Cabelludo Graso Moroccanoil® es un tratamiento profesional para el cuero cabelludo diseñado para controlar la producción excesiva de aceite y revivir el cabello.', 'graso'),
(26, 1, 6, 'Moroccanoil Volumizing Mousse', 28.5, 'images/hair_volumizingmousse.jpg', 'PARA CABELLO FINO A MEDIO : Dé a su cabello volumen y realce inmediato con la Espuma Voluminizadora Moroccanoil®, ideal para cabello medio o fino. Este voluminizador para crear estilos y peinados, provee cuerpo y volumen al cabello sin resultados pegajosos.', 'mousse'),
...
('689399943', 'López Fernández', 'salf1997', '$2y$10$/G/s6ZRWWy6.D9W/YSenLeeT5JJ7znFZXjtms6Q9UaDv6dhkMsIka', 'sofia.lopez_97@hotmail.com', 0, 1);
